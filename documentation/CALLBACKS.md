...
<div align="center">
  ...
  <p>
    ...
    <a href="#functions"><kbd>Functions</kbd></a>
  </p>
</div>
  ...
  <table>
    <tr>
      <td valign="top" align="left"><h4>
        <a href="#onclose"><code>onClose</code></a><br>
        <a href="#onplayerjoin"><code>onPlayerJoin</code></a><br>
        <a href="#onplayerleave"><code>onPlayerLeave</code></a><br>
        <a href="#onplayerjump"><code>onPlayerJump</code></a><br>
        <a href="#onrespawnrequest"><code>onRespawnRequest</code></a><br>
        <a href="#playercommand"><code>playerCommand</code></a><br>
        <a href="#onplayerchat"><code>onPlayerChat</code></a><br>
        <a href="#onplayerchangeblock"><code>onPlayerChangeBlock</code></a><br>
        <a href="#onplayerdropitem"><code>onPlayerDropItem</code></a><br>
        <a href="#onplayerpickedupitem"><code>onPlayerPickedUpItem</code></a><br>
        <a href="#onplayerselectinventoryslot"><code>onPlayerSelectInventorySlot</code></a><br>
        <a href="#onblockstand"><code>onBlockStand</code></a><br>
        <a href="#onplayerattemptcraft"><code>onPlayerAttemptCraft</code></a><br>
        <a href="#onplayercraft"><code>onPlayerCraft</code></a><br>
        <a href="#onplayerattemptopenchest"><code>onPlayerAttemptOpenChest</code></a><br>
        <a href="#onplayeropenedchest"><code>onPlayerOpenedChest</code></a><br>
        <a href="#onplayermoveitemoutofinventory"><code>onPlayerMoveItemOutOfInventory</code></a><br>
        <a href="#onplayermoveinvenitem"><code>onPlayerMoveInvenItem</code></a><br>
        <a href="#onplayermoveitemintoidxs"><code>onPlayerMoveItemIntoIdxs</code></a><br>
        <a href="#onplayerswapinvenslots"><code>onPlayerSwapInvenSlots</code></a>
      </h4></td>
      <td valign="top" align="left"><h4>
        <a href="#onplayermoveinvenitemwithamt"><code>onPlayerMoveInvenItemWithAmt</code></a><br>
        <a href="#onplayerattemptaltaction"><code>onPlayerAttemptAltAction</code></a><br>
        <a href="#onplayeraltaction"><code>onPlayerAltAction</code></a><br>
        <a href="#onplayerclick"><code>onPlayerClick</code></a><br>
        <a href="#onclientoptionupdated"><code>onClientOptionUpdated</code></a><br>
        <a href="#onmobsettingupdated"><code>onMobSettingUpdated</code></a><br>
        <a href="#oninventoryupdated"><code>onInventoryUpdated</code></a><br>
        <a href="#onchestupdated"><code>onChestUpdated</code></a><br>
        <a href="#onworldchangeblock"><code>onWorldChangeBlock</code></a><br>
        <a href="#oncreatebloxdmeshentity"><code>onCreateBloxdMeshEntity</code></a><br>
        <a href="#onentitycollision"><code>onEntityCollision</code></a><br>
        <a href="#onplayerattemptspawnmob"><code>onPlayerAttemptSpawnMob</code></a><br>
        <a href="#onworldattemptspawnmob"><code>onWorldAttemptSpawnMob</code></a><br>
        <a href="#onplayerspawnmob"><code>onPlayerSpawnMob</code></a><br>
        <a href="#onworldspawnmob"><code>onWorldSpawnMob</code></a><br>
        <a href="#onworldattemptdespawnmob"><code>onWorldAttemptDespawnMob</code></a><br>
        <a href="#onmobdespawned"><code>onMobDespawned</code></a><br>
        <a href="#onplayerattack"><code>onPlayerAttack</code></a><br>
        <a href="#onplayerdamagingotherplayer"><code>onPlayerDamagingOtherPlayer</code></a><br>
        <a href="#onplayerdamagingmob"><code>onPlayerDamagingMob</code></a>
      </h4></td>
      <td valign="top" align="left"><h4>
        <a href="#onmobdamagingplayer"><code>onMobDamagingPlayer</code></a><br>
        <a href="#onmobdamagingothermob"><code>onMobDamagingOtherMob</code></a><br>
        <a href="#onattemptkillplayer"><code>onAttemptKillPlayer</code></a><br>
        <a href="#onplayerkilledotherplayer"><code>onPlayerKilledOtherPlayer</code></a><br>
        <a href="#onmobkilledplayer"><code>onMobKilledPlayer</code></a><br>
        <a href="#onplayerkilledmob"><code>onPlayerKilledMob</code></a><br>
        <a href="#onmobkilledothermob"><code>onMobKilledOtherMob</code></a><br>
        <a href="#onplayerpotioneffect"><code>onPlayerPotionEffect</code></a><br>
        <a href="#onplayerdamagingmeshentity"><code>onPlayerDamagingMeshEntity</code></a><br>
        <a href="#onplayerbreakmeshentity"><code>onPlayerBreakMeshEntity</code></a><br>
        <a href="#onplayerusedthrowable"><code>onPlayerUsedThrowable</code></a><br>
        <a href="#onplayerthrowablehitterrain"><code>onPlayerThrowableHitTerrain</code></a><br>
        <a href="#ontouchscreenactionbutton"><code>onTouchscreenActionButton</code></a><br>
        <a href="#ontaskclaimed"><code>onTaskClaimed</code></a><br>
        <a href="#onchunkloaded"><code>onChunkLoaded</code></a><br>
        <a href="#onplayerrequestchunk"><code>onPlayerRequestChunk</code></a><br>
        <a href="#onitemdropcreated"><code>onItemDropCreated</code></a><br>
        <a href="#onplayerstartchargingitem"><code>onPlayerStartChargingItem</code></a><br>
        <a href="#onplayerfinishchargingitem"><code>onPlayerFinishChargingItem</code></a><br>
        <a href="#doperiodicsave"><code>doPeriodicSave</code></a>
      </h4></td>
    </tr>
  </table>
</div>
 ...
 * 
 * @param {number} ms - always equal to 50
 */
tick = (ms) => {}
```
 ...
 * 
 * @param {PlayerId} playerId - The id of the player that joined
...
<a id="onplayerleave"></a>

```js
/**
 * Called when a player leaves the lobby.
 * 
 * @param {PlayerId} playerId - The id of the player that left
 * @param {boolean} serverIsShuttingDown - Whether the server is shutting down
 */
 ...
 * 
 * @param {PlayerId} playerId - The id of the player that jumped
 */
...
<a id="onrespawnrequest"></a>

```js
/**
 * Called when a player requests to respawn, unless they have a spawn point set.
 * (i.e. this WILL NOT be called when a player already has a spawn point set)
 * 
 * Optionally return the respawn location. Defaults to [0, 0, 0].
 * Return true to handle yourself
 *   (good for async, but be careful that the player isn't at the place they died,
 *   as they could pick up their old items or hit the player they were fighting).
 * 
 * @param {PlayerId} playerId - The id of the player that requested to respawn
 */
 ...
 * 
 * @param {PlayerId} playerId - The id of the player that sent the command
 ...
 * Return for most flexibility:
 *   an object where keys are playerIds -
...
<a id="onplayerselectinventoryslot"></a>
 ...
 * 
 * This can run at 20-80 times per second for each of players
 * Making this the fastest callback known, which can lead to more interruptions.
 * 
...
<a id="onplayerattemptopenchest"></a>
...
<a id="onplayermoveitemoutofinventory"></a>
...
<a id="onplayermoveinvenitem"></a>

```js
/**
 * Called for all types of inventory item movement.
 * 
 * Certain methods of moving item can result in splitting a stack into multiple slots. (e.g. shift-click).
...
<a id="onplayermoveitemintoidxs"></a>
...
<a id="onplayermoveinvenitemwithamt"></a>
...
<a id="onplayerattemptaltaction"></a>
...
<a id="onplayerclick"></a>

```js
/**
 * Called when a player clicks.
 * 
 * Do not use important functionality depending on wasAltClick,
...
<a id="oncreatebloxdmeshentity"></a>
...
<a id="onplayerattemptspawnmob"></a>
...
<a id="onworldattemptdespawnmob"></a>
...
<a id="onplayerdamagingotherplayer"></a>
...
<a id="onplayerkilledotherplayer"></a>
...
<a id="onplayerdamagingmeshentity"></a>
...
<a id="onplayerbreakmeshentity"></a>
...
<a id="onplayerthrowablehitterrain"></a>
...
<a id="ontouchscreenactionbutton"></a>
...
<a id="onplayerstartchargingitem"></a>
...
<a id="onplayerfinishchargingitem"></a>
