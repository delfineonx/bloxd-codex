...
```js
/**
 * Start playing the song for a player.
 *
    ...
    <tbody>
      <tr>
        <td valign="top" align="left"><h4>
          <a href="#general"><code>general</code></a><br>
          <a href="#adigold"><code>Adigold</code></a><br>
          <a href="#juhani-junkala"><code>Juhani Junkala</code></a><br>
          <a href="#mojo-productions"><code>Mojo Productions</code></a><br>
        </h4></td>
      </tr>
    </tbody>
  </table>
